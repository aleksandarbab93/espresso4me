<?php
/**
 * Single blog post template — hero image with title overlay.
 */
...
$share_links = mylisting()->sharer()->get_links( [
...
// Output share modal markup in footer (avoids layout cutoff).
add_action( 'mylisting/get-footer', function() use ( $share_links ) {
...
<?php if ( ! empty( $image ) ): ?>
<div class="post-hero" style="background-image: url('<?php echo esc_url( $image ) ?>');">
	<div class="post-hero-overlay"></div>
	<div class="post-hero-content">
		<div class="post-hero-meta">
			<?php foreach ( (array) $categories as $category ): ?>
				<a href="<?php echo esc_url( $category['link'] ) ?>" class="post-hero-tag">
		...
		<a href="#" class="post-hero-share" data-toggle="modal" data-target="#social-share-modal">
...
<section class="i-section blogpost-section post-body-section">
	<div class="container">
